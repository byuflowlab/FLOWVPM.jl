#=##############################################################################
# DESCRIPTION
    Filament edge graph: bounded 2-in/2-out adjacency over particles, plus
    inference, validation, refinement/coarsening, bundle operations, and
    calibration observables. (Split out of the removed legacy splitting file
    2026-09-08 — this machinery is independent of particle splitting.)
=###############################################################################
