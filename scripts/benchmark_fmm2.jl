...
function benchmark_fmm(n_particles; circulation=1.0, Lx=1.0, Ly=1.0, Lz=7.0, overlap=1.3, theta=0.4, p=4, ncrit=50)
...
for (i,n) in enumerate(n_particles)
    ...
    t, np = benchmark_fmm(n; circulation=1.0, Lx=1.0, Ly=1.0, Lz=7.0, overlap=1.3, theta=0.4, p=4, ncrit=50)
