...
The FMM acceleration has been in tested in Linux-based machines (including supercomputing HPC clusters).
...
## Features
  ...
  * Viscous diffusion through core spreading.
  ...
  FLOWVPM is an stand-alone simulation framework, but it has also been integrated and used in the following codes: [FLOWUnsteady](https://github.com/byuflowlab/FLOWUnsteady), [SUAVE](https://suave.stanford.edu/).
